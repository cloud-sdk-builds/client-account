...
[`@aws-sdk/client-account`](https://www.npmjs.com/package/@aws-sdk/client-account/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-account@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hKUatANJbQBdFwLOC/vPy2WS5JYHor1YTRId8aPheHvcdBzh8jCCGyye8I1JAzAq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-account": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-account@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-account@3.300.0/index.min.mjs": "sha384-hKUatANJbQBdFwLOC/vPy2WS5JYHor1YTRId8aPheHvcdBzh8jCCGyye8I1JAzAq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-account/blob/refs/tags/3.300.0/LICENSE
```
